...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        Get instant answers to your questions about AI and robotics with our AI chatbot,
        powered by advanced RAG technology for accurate and contextual responses.
      </>
    ),
  },
  {
